...
async function getTodos() {
    ...
    // console.log(token)
    try {
        const response = await fetch("https://complete-todo-app-backend-1.onrender.com/todos", {
            method: "POST",
            headers: {
...
submit.addEventListener("click", async () => {
    ...
    try {
        ...
        const response = await fetch("https://complete-todo-app-backend-1.onrender.com/todo", {
            method: "POST",
            headers: {
                'Content-Type': 'application/json',
                "token": token,
